...
class PainRelief extends StatefulWidget {
  ...
  @override
  _PainReliefState createState() => _PainReliefState();
}
        ...
        body: Scaffold(
            body: Column(
              children: [
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>const PainRelief()));
                  },
                        ...
                        Container(
                          ...
                          child: ClipOval(
                            child: SizedBox.fromSize(
                              ...
                              child: Image.asset('assets/images/pain-relief1.png', fit: BoxFit.cover),
                            ),
                          ),
                        )
